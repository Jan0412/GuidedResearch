"""cli.py -- the three subcommands, plus `python -m triton_lint`."""
...
from triton_lint.cli import main
...
class TestModuleEntryPoint:
    def test_python_m_triton_lint(self, run_dir, monkeypatch, capsys):
        path = os.path.join(run_dir, "level_1_problem_1_sample_0_kernel.py")
        monkeypatch.setattr(sys, "argv", ["triton_lint", "check", path])

        with pytest.raises(SystemExit) as exc:
            runpy.run_module("triton_lint", run_name="__main__")
