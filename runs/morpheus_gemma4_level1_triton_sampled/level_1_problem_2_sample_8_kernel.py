...
def matmul_kernel(
    ...
    for k in range(0, tl.cdiv(K, BLOCK_SIZE_K)):
        ...
        # Masking is handled by the modulo/range logic implicitly if dimensions are multiples, 
        # but for robustness we use explicit masks.
...
class ModelNew(nn.Module):
    """
    Optimized model that performs a single matrix multiplication using Triton kernels.
    """
    def __init__(self):
