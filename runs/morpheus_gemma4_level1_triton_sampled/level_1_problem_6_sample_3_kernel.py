...
def matmul_kernel(
    ...
    # Initialize pointers for the A and B blocks
    # A is (M, K), B is (K, N)
    ...
    # Iterate over the K dimension in chunks of BLOCK_SIZE_K
    for k in range(0, tl.cdiv(K, BLOCK_SIZE_K)):
        ...
        # Perform matrix multiplication of the blocks and accumulate
...
def triton_matmul(a: torch.Tensor, b: torch.Tensor):
    ...
    # Grid dimensions: number of blocks needed to cover the output matrix
