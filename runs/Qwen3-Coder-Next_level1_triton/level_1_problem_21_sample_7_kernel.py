...
def sigmoid_kernel(
    ...
    # Use optimized computation to avoid overflow
    # For large negative x, sigmoid approaches 0; for large positive x, sigmoid approaches 1
    # Use piecewise approximation for better numerical stability
    # tl.where handles conditional selection
