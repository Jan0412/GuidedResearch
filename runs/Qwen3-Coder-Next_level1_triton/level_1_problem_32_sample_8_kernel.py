...
defhardtanh_kernel(
    ...
    # tl.maximum and tl.minimum are used for efficient clamping
    x_clamped = tl.maximum(tl.minimum(x, 1.0), -1.0)
...
class ModelNew(nn.Module):
    ...
    def forward(self, x: torch.Tensor) -> torch.Tensor:
        """
        Applies HardTanh activation using Triton kernel to the input tensor.
