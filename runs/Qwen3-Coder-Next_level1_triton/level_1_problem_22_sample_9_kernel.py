...
def tanh_kernel(
    ...
    # This is more efficient than the direct tanh implementation in Triton
    # for FP32 as it uses the optimized sigmoid kernel internally
    z = 2.0 * x
    sigmoid_z = 1.0 / (1.0 + tl.exp(-z))
    tanh_x = 2.0 * sigmoid_z - 1.0
    # Store the result
