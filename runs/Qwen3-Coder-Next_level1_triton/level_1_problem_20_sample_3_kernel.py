...
def leaky_relu_kernel(
    ...
    negative_slope,  # Negative slope for negative values
    ...
    # Apply LeakyReLU: max(x, negative_slope * x) for negative values
    # Optimized implementation: x if x > 0 else negative_slope * x
...
def triton_leaky_relu(x: torch.Tensor, negative_slope: float = 0.01):
    """
    This function wraps the Triton kernel call for LeakyReLU. It:
