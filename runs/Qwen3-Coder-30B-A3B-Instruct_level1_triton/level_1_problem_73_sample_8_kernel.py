    ...
    for k_d in range(kernel_size):
        for k_h in range(kernel_size):
            for k_w in range(kernel_size):
                ...
                d_in = out_d_idx * stride - padding + k_d
                ...
                if (d_in >= 0 and d_in < input_depth and
                    ...
                    input_idx = batch_idx * (in_channels * input_depth * input_height * input_width) + \
                                (out_c_idx % group_size) * (input_depth * input_height * input_width) + \
                                d_in * (input_height * input_width) + \
                                h_in * input_width + \
                                w_in
                    
                    # Calculate weight index
                    weight_idx = out_c_idx * (group_size * kernel_size * kernel_size * kernel_size) + \
                                 (out_c_idx % group_size) * (kernel_size * kernel_size * kernel_size) + \
