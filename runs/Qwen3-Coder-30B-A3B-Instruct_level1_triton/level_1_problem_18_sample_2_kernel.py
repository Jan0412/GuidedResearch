...
def triton_matmul(a: torch.Tensor, b: torch.Tensor):
    ...
    # Transpose inputs to match expected layout
    a_transposed = a.T.contiguous()
    b_transposed = b.T.contiguous()
    
    # Prepare output tensor
    M, K = a_transposed.shape
    K, N = b_transposed.shape
    ...
    # Launch kernel
    matmul_kernel[grid](
        a_transposed, b_transposed, c,
        M, N, K,
        a_transposed.stride(0), a_transposed.stride(1),
