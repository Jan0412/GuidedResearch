...
def matmul_kernel(
    ...
    # Of course, the last block is special, if the total number
    # of K elements doesn't divide by BLOCK_SIZE_K
    accumulator = tl.zeros((BLOCK_SIZE_M, BLOCK_SIZE_N), dtype=tl.float32)
    for k in range(0, tl.cdiv(K, BLOCK_SIZE_K)):
        # Load the next block of A and B, generating a mask by checking the K dimension.
...
def triton_matmul(a, b, activation="none"):
    ...
    Args:
        ...
        activation (str): Activation function to apply ("none" or "leaky_relu")
    ...
    # Explicitly cast to float32 for computation
