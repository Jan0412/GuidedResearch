...
def depthwise_conv2d_kernel(
    ...
    input_tile = tl.shared.tensor([BLOCK_SIZE, BLOCK_SIZE], tl.float32)
    ...
    for kh in range(kernel_height):
        for kw in range(kernel_width):
            ...
            ih = out_h + kh * dilation_h - padding_h
            iw = out_w + kw * dilation_w - padding_w
...
class ModelNew(nn.Module):
    ...
    def forward(self, x: torch.Tensor) -> torch.Tensor:
        ...
        kernel_height, kernel_width = self.kernel_size, 1
