...
# Same convention as reranker/src/data/build_dataset.py::_staged_kernel_path,
# duplicated here so triton_lint stays dependency-free.
# --------------------------------------------------------------------------
...
def build_summary(model: ModuleModel, findings: list[Finding]) -> dict:
